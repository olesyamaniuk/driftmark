document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".p-t-navigation-list");
  const headerRef = document.querySelector(".p-t-header");
  const navigationRef = document.querySelector(".p-t-navigation");
  ...
  document.querySelectorAll(".p-t-navigation-link").forEach((n) =>
...
function toggleAnswer(element) {
  ...
  const buttonImg = element.querySelector(".p-t-toggle-button img");
